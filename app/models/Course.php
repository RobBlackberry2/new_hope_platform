...
class Course {
    ...
    public function create(string $nombre, string $descripcion, int $grado, int $docente_user_id): int|false {
        $stmt = $this->db->prepare('INSERT INTO courses (nombre, descripcion, grado, docente_user_id) VALUES (?,?,?,?)');
        $stmt->bind_param('ssii', $nombre, $descripcion, $grado, $docente_user_id);
